...
public static class MetaPlanetTutorialLocalizationSeeder
{
    ...
    private static readonly PhraseDef[] Phrases =
    {
        ...
        new PhraseDef("meta_tutorial_step0_dialog_2", "Здесь создаются технологии для будущих планет.", "This is where we build tech for future planets.", "Тут ми створюємо технології для майбутніх планет.", "Aquí creamos tecnología para planetas futuros."),
        new PhraseDef("meta_tutorial_step0_dialog_3", "И иногда происходят научные происшествия.", "And sometimes, science gets a little messy.", "Іноді наука трохи виходить з-під контролю.", "Y a veces la ciencia se desordena un poco."),
        new PhraseDef("meta_tutorial_step0_dialog_4", "Но сегодня мы просто познакомимся с базой.", "But today, we just get to know the base.", "Але сьогодні ми просто познайомимося з базою.", "Pero hoy solo conoceremos la base."),
        new PhraseDef("meta_tutorial_step1_reward_title", "Стартовый бюджет", "Starting Budget", "Стартовий бюджет", "Presupuesto inicial"),
        new PhraseDef("meta_tutorial_step1_reward_description", "Подрядчик выделил средства на развитие станции.", "The contractor assigned funds for station growth.", "Підрядник виділив кошти на розвиток станції.", "El contratista asignó fondos para desarrollar la estación."),
        ...
        new PhraseDef("meta_tutorial_step1_dialog_3", "Покажу, куда их можно потратить.", "I will show you where to spend them.", "Покажу, куди їх можна витратити.", "Te enseñaré dónde gastarlos."),
        new PhraseDef("meta_tutorial_step2_dialog_1", "Сначала посмотрим на варианты объектов.", "First, let us look at object variants.", "Спершу подивимося на варіанти об'єктів.", "Primero veremos las variantes de objetos."),
        new PhraseDef("meta_tutorial_step2_dialog_2", "Они позволяют менять внешний вид станции.", "They change how the station looks.", "Вони змінюють вигляд станції.", "Cambian el aspecto de la estación."),
        new PhraseDef("meta_tutorial_step2_dialog_3", "Практической пользы немного.", "They are not very practical.", "Практичної користі небагато.", "No son muy prácticos."),
        new PhraseDef("meta_tutorial_step2_dialog_4", "Но выглядят красиво.", "But they look nice.", "Зате виглядають гарно.", "Pero se ven muy bien."),
        new PhraseDef("meta_tutorial_step2_open_variant_hint", "Нажми сюда.", "Tap here.", "Натисни тут.", "Toca aquí."),
        new PhraseDef("meta_tutorial_step3_add_variant_hint", "Для начала разместим новый объект.\nПока это просто коробка с доставкой.\nСодержимое узнаем после распаковки.", "First, place a new object.\nFor now it is just a delivery box.\nWe will see what is inside after unpacking.", "Спершу розмістимо новий об'єкт.\nПоки що це просто коробка з доставкою.\nЩо всередині, дізнаємося після розпакування.", "Primero coloca un objeto nuevo.\nPor ahora es solo una caja de entrega.\nVeremos qué hay dentro al abrirla."),
        ...
        new PhraseDef("meta_tutorial_step5_dialog_1", "Теперь выберем внешний вид.", "Now let us choose the look.", "Тепер виберемо зовнішній вигляд.", "Ahora elegiremos el aspecto."),
        ...
        new PhraseDef("meta_tutorial_step5_dialog_3", "Но станция будет выглядеть гораздо лучше.", "But the station will look much better.", "Але станція виглядатиме значно краще.", "Pero la estación se verá mucho mejor."),
        ...
        new PhraseDef("meta_tutorial_step6_dialog_1", "А вот это уже действительно полезно.", "Now this is truly useful.", "А ось це вже справді корисно.", "Esto sí que es útil."),
        new PhraseDef("meta_tutorial_step6_dialog_2", "Улучшения влияют на все будущие планеты.", "Upgrades affect every future planet.", "Покращення впливають на всі майбутні планети.", "Las mejoras afectan a todos los planetas futuros."),
        ...
        new PhraseDef("meta_tutorial_step7_intro_1", "Каждое улучшение представляет отдельное направление исследований.", "Each upgrade is its own research path.", "Кожне покращення має окремий напрям досліджень.", "Cada mejora es una línea de investigación."),
        new PhraseDef("meta_tutorial_step7_intro_2", "Сначала разместим его на станции.", "First, place it on the station.", "Спершу розмістимо його на станції.", "Primero colócala en la estación."),
        ...
        new PhraseDef("meta_tutorial_step8_upgrade_hint", "Каждое улучшение можно прокачать до трёх уровней.\nКаждый уровень усиливает бонус.\n\nЭта кнопка делает цифры больше.", "Each upgrade has up to three levels.\nEach level makes the bonus stronger.\n\nThis button makes the numbers bigger.", "Кожне покращення можна підняти до трьох рівнів.\nКожен рівень посилює бонус.\n\nЦя кнопка робить числа більшими.", "Cada mejora tiene hasta tres niveles.\nCada nivel aumenta la bonificación.\n\nEste botón hace crecer los números."),
        ...
        new PhraseDef("meta_tutorial_step8_done_2", "Этот бонус будет работать на всех будущих планетах.", "This bonus will help every future planet.", "Цей бонус працюватиме на всіх майбутніх планетах.", "Esta bonificación ayudará a todos los planetas futuros."),
        ...
        new PhraseDef("meta_tutorial_step8_done_4", "Хотя красивые дома тоже хороши.", "Though pretty houses are nice too.", "Хоча красиві будинки теж хороші.", "Aunque las casas bonitas también ayudan."),
        new PhraseDef("meta_tutorial_step9_dialog_1", "Вы принимаете заказы на создание планет?", "Do you accept orders for planet creation?", "Ви приймаєте замовлення на створення планет?", "¿Aceptan pedidos para crear planetas?"),
        new PhraseDef("meta_tutorial_step9_dialog_2", "Конечно принимаем.", "Of course we do.", "Звісно, приймаємо.", "Claro que sí."),
        new PhraseDef("meta_tutorial_step9_dialog_3", "Это буквально единственная причина существования этой станции.", "That is literally why this station exists.", "Це буквально єдина причина існування цієї станції.", "Esa es literalmente la razón de esta estación."),
        new PhraseDef("meta_tutorial_step9_dialog_4", "Мне нужна планета с разумными существами.", "I require a planet with intelligent beings.", "Мені потрібна планета з розумними істотами.", "Necesito un planeta con seres inteligentes."),
        new PhraseDef("meta_tutorial_step9_dialog_5", "Они должны производить детали для ремонта моего корпуса.", "They must produce parts to repair my frame.", "Вони мають виробляти деталі для ремонту мого корпусу.", "Deben fabricar piezas para reparar mi chasis."),
        new PhraseDef("meta_tutorial_step9_dialog_6", "Прекрасный заказ.", "A wonderful order.", "Чудове замовлення.", "Un pedido excelente."),
        new PhraseDef("meta_tutorial_step9_dialog_7", "Что может пойти не так?", "What could go wrong?", "Що може піти не так?", "¿Qué podría salir mal?"),
        new PhraseDef("meta_tutorial_step9_dialog_8", "Меня немного пугает ваш энтузиазм.", "Your enthusiasm is mildly concerning.", "Ваш ентузіазм трохи насторожує.", "Su entusiasmo me preocupa ligeramente."),
